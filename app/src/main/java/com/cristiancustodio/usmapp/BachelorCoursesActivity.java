...
public class BachelorCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BachelorListItem bachelorListItem17 = new BachelorListItem("SUP 340 - The Gifts of the Holy Spirit in the Now I", "2 Credits");
        BachelorListItem bachelorListItem18 = new BachelorListItem("SUP 340 - The Gifts of the Holy Spirit in the Now II", "2Credits");
        ...
        BachelorListItem bachelorListItem21 = new BachelorListItem("KPG 210 - Kingdom Economic Principle", "2 Credits");
