...
public class NonCreditApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_credit_application);

        //Inflate the actionbar
        Toolbar myToolbar = (Toolbar) findViewById(R.id.nonCreditApplicationToolbar);
        ...
        //Load FormSite url Admission Application
        mWebview  = (WebView) findViewById(R.id.NonCreditPortalView);
        ...
        mWebview.loadUrl("https://fs2.formsite.com/universitykingjesusministryorg/form15/index.html");
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        ...
        ActionMenuView bottomBar = (ActionMenuView)findViewById(R.id.bottom_toolbar_nonCreditPortal);
