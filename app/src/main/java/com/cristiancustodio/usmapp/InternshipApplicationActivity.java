...
public class InternshipApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.internshipApplicationToolbar);
        ...
        mWebview  = (WebView) findViewById(R.id.internshipPortalView);
        ...
        mWebview.loadUrl("https://fs2.formsite.com/universitykingjesusministryorg/form12/index.html");
    }
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        ...
        ActionMenuView bottomBar = (ActionMenuView)findViewById(R.id.bottom_toolbar_internshipPortal);
