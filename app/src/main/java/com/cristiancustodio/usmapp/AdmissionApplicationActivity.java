...
public class AdmissionApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.studentPortalToolbar);
        ...
        mWebview  = (WebView) findViewById(R.id.applicationWebView);
        ...
        mWebview.loadUrl("https://fs2.formsite.com/universitykingjesusministryorg/form2/index.html");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_register_bottom:
                Intent intent4 = new Intent(this, AdmissionApplicationActivity.class);
                startActivity(intent4);
                return true;

            case R.id.action_graduation_bottom:
                Intent intent5 = new Intent(this, DegreeAuditSelectionActivity.class);
