...
public class StudentPortalActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWebview  = (WebView) findViewById(R.id.studentPortalView);
        ...
        mWebview.loadUrl("http://usm.kingjesusministry.org/ets/login.aspx");
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        ...
        ActionMenuView bottomBar = (ActionMenuView)findViewById(R.id.bottom_toolbar_Portal);
