...
public class AcademicProgramsActivity extends AppCompatActivity {
...
//Prevent landscape orientation
    ...
    public void AssociateCoursesButton(View view) {
        Intent intent = new Intent(this, AssociateCoursesActivity.class);
        startActivity(intent);
    }

    public void BachelorCoursesButton (View view) {
        Intent intent = new Intent(this, BachelorCoursesActivity.class);
        startActivity(intent);
    }
