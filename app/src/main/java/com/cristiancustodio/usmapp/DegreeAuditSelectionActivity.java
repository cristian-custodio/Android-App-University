...
public class DegreeAuditSelectionActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_degree_audit_selection);
    ...
    public boolean onCreateOptionsMenu (Menu menu){
        ...
        ActionMenuView bottomBar = (ActionMenuView)findViewById(R.id.bottom_toolbar_home_degree);
